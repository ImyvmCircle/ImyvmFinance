...
public final class SimulationFormula {
    ...
    public static SimulationFormula parse(String source) {
        ...
        List<Map<String, Double>> samples = List.of(
            Map.of("PREV_PRICE",10000d,"PREV_LOG_RETURN",0d,"DRIFT_BPS",10d,"VOLATILITY_BPS",20d,"MAX_MOVE_BPS",100d,"RANDOM",.25d,"ITERATION",1d,"HISTORY_COUNT",5d),
            Map.of("PREV_PRICE",1d,"PREV_LOG_RETURN",-20d,"DRIFT_BPS",-10d,"VOLATILITY_BPS",0d,"MAX_MOVE_BPS",1d,"RANDOM",-.9d,"ITERATION",20d,"HISTORY_COUNT",5d),
            Map.of("PREV_PRICE",1000000d,"PREV_LOG_RETURN",80d,"DRIFT_BPS",100d,"VOLATILITY_BPS",250d,"MAX_MOVE_BPS",500d,"RANDOM",.9d,"ITERATION",3d,"HISTORY_COUNT",120d));
